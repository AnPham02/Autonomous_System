/*
 * QBot2e_Diff_Drive_Kinematics.h
 *
...
#ifndef RTW_HEADER_QBot2e_Diff_Drive_Kinematics_h_
#define RTW_HEADER_QBot2e_Diff_Drive_Kinematics_h_
#include <math.h>
#include <string.h>
#ifndef QBot2e_Diff_Drive_Kinematics_COMMON_INCLUDES_
# define QBot2e_Diff_Drive_Kinematics_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                       /* QBot2e_Diff_Drive_Kinematics_COMMON_INCLUDES_ */

#include "QBot2e_Diff_Drive_Kinematics_types.h"
...
#define QBot2e_Diff_Drive_Kinematics_rtModel RT_MODEL_QBot2e_Diff_Drive_Ki_T

/* Block signals for system '<S4>/Qbot2e_Diff_Drive_Kinematics' */
typedef struct {
  real_T vC;                           /* '<S4>/Qbot2e_Diff_Drive_Kinematics' */
  real_T Omega;                        /* '<S4>/Qbot2e_Diff_Drive_Kinematics' */
} B_Qbot2e_Diff_Drive_Kinematic_T;

/* Block signals (default storage) */
typedef struct {
  real_T HILRead1_o4;                  /* '<S11>/HIL Read1' */
  real_T Product;                      /* '<S3>/Product' */
  real_T Product1;                     /* '<S9>/Product1' */
  real_T Product1_k;                   /* '<S7>/Product1' */
  real_T mmtom;                        /* '<S6>/mm to m' */
  real_T x0;                           /* '<S7>/x0' */
  real_T Product_a;                    /* '<S7>/Product' */
  real_T mmtom_e;                      /* '<S8>/mm to m' */
  real_T x0_n;                         /* '<S9>/x0' */
  ...
  real_T Sum;                          /* '<S12>/Sum' */
  real_T div;                          /* '<S12>/div' */
  B_Qbot2e_Diff_Drive_Kinematic_T sf_Qbot2e_Diff_Drive_Kinemati_i;/* '<S5>/Qbot2e_Diff_Drive_Kinematics' */
  B_Qbot2e_Diff_Drive_Kinematic_T sf_Qbot2e_Diff_Drive_Kinematics;/* '<S4>/Qbot2e_Diff_Drive_Kinematics' */
} B_QBot2e_Diff_Drive_Kinematic_T;
...
typedef struct {
  ...
  real_T HILWrite_OtherBuffer[2];      /* '<S11>/HIL Write' */
  t_card HILInitialize_Card;           /* '<Root>/HIL Initialize' */
  void *HILRead1_PWORK;                /* '<S11>/HIL Read1' */
  struct {
    void *LoggedData;
  } Omega_PWORK;                       /* '<Root>/Omega' */
...
} DW_QBot2e_Diff_Drive_Kinemati_T;
...
} X_QBot2e_Diff_Drive_Kinematic_T;
...
typedef struct {
  ...
  real_T Integrator1_CSTATE;           /* '<S7>/Integrator1' */
  real_T Integrator1_CSTATE_c;         /* '<S9>/Integrator1' */
} XDot_QBot2e_Diff_Drive_Kinema_T;
...
} XDis_QBot2e_Diff_Drive_Kinema_T;
...
#define rtB                            QBot2e_Diff_Drive_Kinematics_B
#define BlockIO                        B_QBot2e_Diff_Drive_Kinematic_T
#define rtX                            QBot2e_Diff_Drive_Kinematics_X
#define ContinuousStates               X_QBot2e_Diff_Drive_Kinematic_T
#define rtXdot                         QBot2e_Diff_Drive_Kinemati_XDot
#define StateDerivatives               XDot_QBot2e_Diff_Drive_Kinema_T
#define tXdis                          QBot2e_Diff_Drive_Kinemati_XDis
#define StateDisabled                  XDis_QBot2e_Diff_Drive_Kinema_T
#define rtP                            QBot2e_Diff_Drive_Kinematics_P
#define Parameters                     P_QBot2e_Diff_Drive_Kinematic_T
#define rtDWork                        QBot2e_Diff_Drive_Kinematics_DW
#define D_Work                         DW_QBot2e_Diff_Drive_Kinemati_T

/* Parameters (default storage) */
struct P_QBot2e_Diff_Drive_Kinematic_T_ {
  ...
  real_T SecondOrderLowPassFilter2_inp_c;
                               ...
                               * Referenced by: '<S7>/zt'
                               */
  real_T SecondOrderLowPassFilter2_inp_e;
  ...
  real_T Constant2_Value;              /* Expression: 0.1
                                        ...
                                        */
  real_T Constant_Value_l;             /* Expression: 0.1
  ...
  real_T tickstoencoderrotation_Gain_a;/* Expression: 2*pi/52
                                        ...
                                        */
  real_T encoderrotationtowheelrotatio_m;/* Expression: 1/49.5833
                                          * Referenced by: '<S8>/ encoder rotation to wheel rotation (gear ratio)'
                                          */
  real_T wheelradiousmm_Gain_b;        /* Expression: 35
...
struct tag_RTM_QBot2e_Diff_Drive_Kin_T {
  const char_T *path;
...
extern P_QBot2e_Diff_Drive_Kinematic_T QBot2e_Diff_Drive_Kinematics_P;

/* Block signals (default storage) */
extern B_QBot2e_Diff_Drive_Kinematic_T QBot2e_Diff_Drive_Kinematics_B;

/* Continuous states (default storage) */
extern X_QBot2e_Diff_Drive_Kinematic_T QBot2e_Diff_Drive_Kinematics_X;

/* Block states (default storage) */
extern DW_QBot2e_Diff_Drive_Kinemati_T QBot2e_Diff_Drive_Kinematics_DW;

/* Model entry point functions */
extern void QBot2e_Diff_Drive_Kinematics_initialize(void);
extern void QBot2e_Diff_Drive_Kinematics_output(void);
extern void QBot2e_Diff_Drive_Kinematics_update(void);
extern void QBot2e_Diff_Drive_Kinematics_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern QBot2e_Diff_Drive_Kinematics_rtModel *QBot2e_Diff_Drive_Kinematics(void);
...
extern RT_MODEL_QBot2e_Diff_Drive_Ki_T *const QBot2e_Diff_Drive_Kinematics_M;
 ...
 *
 * '<Root>' : 'QBot2e_Diff_Drive_Kinematics'
 * '<S1>'   : 'QBot2e_Diff_Drive_Kinematics/Encoder_to_Velocity'
 * '<S2>'   : 'QBot2e_Diff_Drive_Kinematics/Encoder_to_Velocity1'
 * '<S3>'   : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Basic Motor Commands and Sensor Measurement'
 * '<S4>'   : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Diff Drive Kinematics'
 * '<S5>'   : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Diff Drive Kinematics2'
 * '<S6>'   : 'QBot2e_Diff_Drive_Kinematics/Encoder_to_Velocity/Encoder to Distance'
 * '<S7>'   : 'QBot2e_Diff_Drive_Kinematics/Encoder_to_Velocity/Second-Order Low-Pass Filter2'
 * '<S8>'   : 'QBot2e_Diff_Drive_Kinematics/Encoder_to_Velocity1/Encoder to Distance'
 * '<S9>'   : 'QBot2e_Diff_Drive_Kinematics/Encoder_to_Velocity1/Second-Order Low-Pass Filter2'
 * '<S10>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal'
 * '<S11>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Basic Motor Commands and Sensor Measurement/QBot2e_IO_Basic'
 * '<S12>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Enabled Moving Average'
 * '<S13>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Switch Case Action Subsystem'
 * '<S14>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Switch Case Action Subsystem1'
 * '<S15>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Switch Case Action Subsystem2'
 * '<S16>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Enabled Moving Average/Increment'
 * '<S17>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Diff Drive Kinematics/Qbot2e_Diff_Drive_Kinematics'
 * '<S18>'  : 'QBot2e_Diff_Drive_Kinematics/QBot 2e Diff Drive Kinematics2/Qbot2e_Diff_Drive_Kinematics'
 */
#endif                          /* RTW_HEADER_QBot2e_Diff_Drive_Kinematics_h_ */
