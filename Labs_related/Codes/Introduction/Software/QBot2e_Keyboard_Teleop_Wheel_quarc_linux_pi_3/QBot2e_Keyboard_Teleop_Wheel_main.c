 ...
 * External functions *
 *====================*/
EXTERN RT_MODEL * QBot2e_Keyboard_Teleop_Wheel(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(QBot2e_Keyboard_Teleop_Wheel_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QBot2e_Keyboard_Teleop_Wheel -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = QBot2e_Keyboard_Teleop_Wheel();
  if (rtmGetErrorStatus(S) != NULL) {
