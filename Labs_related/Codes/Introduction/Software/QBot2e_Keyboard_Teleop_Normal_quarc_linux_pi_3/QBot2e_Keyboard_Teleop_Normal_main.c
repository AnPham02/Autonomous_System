/****************************************************************************
 * QBot2e_Keyboard_Teleop_Normal_main.c
 *
 * This file was generated automatically by QUARC. It serves as the main
 * entry point for the real-time code.
 *
 * Date:           Tue May 23 12:02:36 2023
 * Model version:  1.247
 * Matlab version: 9.2 (R2019b) 18-Jul-2019
 ****************************************************************************/
...
typedef RT_MODEL_QBot2e_Keyboard_Tele_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * QBot2e_Keyboard_Teleop_Normal(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(QBot2e_Keyboard_Teleop_Norma_M, GBLbuf.message);
}
...
qthread_return_t QTHREAD_DECL subrate_start_routine(void * argument)
{
  ...
  qsigaddset(&signal_set, SIGRTMAX);
                                   /* SIGRTMAX is used by the qtimer routines */
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "tcpip://192.168.2.53:17001?keep_alive=1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QBot2e_Keyboard_Teleop_Normal -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = QBot2e_Keyboard_Teleop_Normal();
  if (rtmGetErrorStatus(S) != NULL) {
