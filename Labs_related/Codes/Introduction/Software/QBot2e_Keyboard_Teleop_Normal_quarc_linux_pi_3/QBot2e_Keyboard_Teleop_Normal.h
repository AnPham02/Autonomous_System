/*
 * QBot2e_Keyboard_Teleop_Normal.h
 *
...
#ifndef RTW_HEADER_QBot2e_Keyboard_Teleop_Normal_h_
#define RTW_HEADER_QBot2e_Keyboard_Teleop_Normal_h_
#include <math.h>
#include <string.h>
#ifndef QBot2e_Keyboard_Teleop_Normal_COMMON_INCLUDES_
# define QBot2e_Keyboard_Teleop_Normal_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                      /* QBot2e_Keyboard_Teleop_Normal_COMMON_INCLUDES_ */

#include "QBot2e_Keyboard_Teleop_Normal_types.h"
...
#define QBot2e_Keyboard_Teleop_Normal_rtModel RT_MODEL_QBot2e_Keyboard_Tele_T

/* Block signals (default storage) */
typedef struct {
  uint8_T ImageCompress_j[921600];     /* '<S7>/Image Compress' */
  uint16_T Gain7[307200];              /* '<Root>/Gain7' */
  uint8_T ImageCompress[307200];       /* '<S6>/Image Compress' */
  t_uint64 Video3DCapture1_o2;         /* '<Root>/Video3D Capture1' */
  t_uint64 Video3DCapture_o2;          /* '<Root>/Video3D Capture' */
  real_T HILRead1_o1;                  /* '<S13>/HIL Read1' */
  real_T HILRead1_o4;                  /* '<S13>/HIL Read1' */
  ...
  real_T x0;                           /* '<S9>/x0' */
  real_T Product_f;                    /* '<S9>/Product' */
  real_T Product1;                     /* '<S9>/Product1' */
  real_T mmtom_p;                      /* '<S10>/mm to m' */
  real_T x0_o;                         /* '<S11>/x0' */
  ...
  real_T x_dot; /* '<S20>/Qbot2_Kinematics (Vf,W to x_dot,y_dot and psi_dot)' */
  real_T y_dot; /* '<S20>/Qbot2_Kinematics (Vf,W to x_dot,y_dot and psi_dot)' */
  real_T psi_dot;
                /* '<S20>/Qbot2_Kinematics (Vf,W to x_dot,y_dot and psi_dot)' */
  real_T Omega;                        /* '<S19>/Qbot2_Diff_Drive_Kinematics' */
  real_T VVavg;                        /* '<S17>/V-Vavg' */
  real_T Vin;                          /* '<S16>/Vin' */
  real_T Constant;                     /* '<S15>/Constant' */
  real_T Count;                        /* '<S18>/Count' */
  real_T Sum;                          /* '<S14>/Sum' */
  real_T div;                          /* '<S14>/div' */
  t_channel Channel;                   /* '<S6>/Channel' */
  t_channel Channel_j;                 /* '<S7>/Channel' */
...
} B_QBot2e_Keyboard_Teleop_Norm_T;
...
typedef struct {
  ...
  t_jpeg_compress ImageCompress_Compress;/* '<S6>/Image Compress' */
  t_jpeg_compress ImageCompress_Compress_a;/* '<S7>/Image Compress' */
  ...
  struct {
    void *Fifo;
  } Channel_PWORK;                     /* '<S6>/Channel' */

  struct {
    void *Fifo;
  } Channel_PWORK_d;                   /* '<S7>/Channel' */
  ...
  int32_T ImageCompress_DIMS1;         /* '<S6>/Image Compress' */
  int32_T ImageCompress_DIMS1_i;       /* '<S7>/Image Compress' */
  ...
  int_T Integrator1_IWORK_o;           /* '<S11>/Integrator1' */
  ...
  int8_T SwitchCaseActionSubsystem1_Subs;
                                     /* '<S12>/Switch Case Action Subsystem1' */
  int8_T SwitchCaseActionSubsystem_Subsy;
                                      /* '<S12>/Switch Case Action Subsystem' */
  int8_T EnabledMovingAverage_SubsysRanB;/* '<S12>/Enabled Moving Average' */
  uint8_T ImageCompress_ScanLine[5120];/* '<S6>/Image Compress' */
  uint8_T ImageCompress_ScanLine_l[15360];/* '<S7>/Image Compress' */
...
} DW_QBot2e_Keyboard_Teleop_Nor_T;
...
typedef struct {
  ...
  real_T Integrator1_CSTATE_l;         /* '<S9>/Integrator1' */
  real_T Integrator2_CSTATE_m;         /* '<S9>/Integrator2' */
  real_T Integrator1_CSTATE_f;         /* '<S11>/Integrator1' */
  real_T Integrator2_CSTATE_g;         /* '<S11>/Integrator2' */
  real_T Integrator_CSTATE;            /* '<S20>/Integrator' */
} X_QBot2e_Keyboard_Teleop_Norm_T;
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_g;         /* '<S11>/Integrator2' */
  real_T Integrator_CSTATE;            /* '<S20>/Integrator' */
} XDot_QBot2e_Keyboard_Teleop_N_T;
...
typedef struct {
  ...
  boolean_T Integrator1_CSTATE_l;      /* '<S9>/Integrator1' */
  boolean_T Integrator2_CSTATE_m;      /* '<S9>/Integrator2' */
  boolean_T Integrator1_CSTATE_f;      /* '<S11>/Integrator1' */
  boolean_T Integrator2_CSTATE_g;      /* '<S11>/Integrator2' */
  boolean_T Integrator_CSTATE;         /* '<S20>/Integrator' */
} XDis_QBot2e_Keyboard_Teleop_N_T;
...
#define rtB                            QBot2e_Keyboard_Teleop_Normal_B
#define BlockIO                        B_QBot2e_Keyboard_Teleop_Norm_T
#define rtX                            QBot2e_Keyboard_Teleop_Normal_X
#define ContinuousStates               X_QBot2e_Keyboard_Teleop_Norm_T
#define rtXdot                         QBot2e_Keyboard_Teleop_Nor_XDot
#define StateDerivatives               XDot_QBot2e_Keyboard_Teleop_N_T
#define tXdis                          QBot2e_Keyboard_Teleop_Nor_XDis
#define StateDisabled                  XDis_QBot2e_Keyboard_Teleop_N_T
#define rtP                            QBot2e_Keyboard_Teleop_Normal_P
#define Parameters                     P_QBot2e_Keyboard_Teleop_Norm_T
#define rtDWork                        QBot2e_Keyboard_Teleop_Norma_DW
#define D_Work                         DW_QBot2e_Keyboard_Teleop_Nor_T

/* Parameters (default storage) */
struct P_QBot2e_Keyboard_Teleop_Norm_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: 2
                                        ...
                                        */
  real_T Gain3_Gain;                   /* Expression: 0.6
  ...
  boolean_T VideoDisplay_UseHardware;
                                  ...
                                  */
  boolean_T VideoDisplay_UseHardware_h;
                               /* Computed Parameter: VideoDisplay_UseHardware_h
...
extern P_QBot2e_Keyboard_Teleop_Norm_T QBot2e_Keyboard_Teleop_Normal_P;

/* Block signals (default storage) */
extern B_QBot2e_Keyboard_Teleop_Norm_T QBot2e_Keyboard_Teleop_Normal_B;

/* Continuous states (default storage) */
extern X_QBot2e_Keyboard_Teleop_Norm_T QBot2e_Keyboard_Teleop_Normal_X;

/* Block states (default storage) */
extern DW_QBot2e_Keyboard_Teleop_Nor_T QBot2e_Keyboard_Teleop_Norma_DW;
...
extern void QBot2e_Keyboard_Teleop_Normal_initialize(void);
extern void QBot2e_Keyboard_Teleop_Normal_output0(void);
extern void QBot2e_Keyboard_Teleop_Normal_update0(void);
extern void QBot2e_Keyboard_Teleop_Normal_output(int_T tid);
extern void QBot2e_Keyboard_Teleop_Normal_update(int_T tid);
extern void QBot2e_Keyboard_Teleop_Normal_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern QBot2e_Keyboard_Teleop_Normal_rtModel *QBot2e_Keyboard_Teleop_Normal(void);
...
extern RT_MODEL_QBot2e_Keyboard_Tele_T *const QBot2e_Keyboard_Teleop_Norma_M;
 ...
 *
 * '<Root>' : 'QBot2e_Keyboard_Teleop_Normal'
 * '<S1>'   : 'QBot2e_Keyboard_Teleop_Normal/Encoder_to_Velocity1'
 * '<S2>'   : 'QBot2e_Keyboard_Teleop_Normal/Encoder_to_Velocity2'
 * '<S3>'   : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Basic Motor Commands and Sensor Measurement'
 * '<S4>'   : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Full Kinematics (No Gyro)'
 * '<S5>'   : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Inverse Kinematics  (Forward Velocity and Angular Velocity  into Left and Right Wheel Vellocity)'
 * '<S6>'   : 'QBot2e_Keyboard_Teleop_Normal/Video Compressed Display (Depth)1'
 * '<S7>'   : 'QBot2e_Keyboard_Teleop_Normal/Video Compressed Display (RGB)1'
 * '<S8>'   : 'QBot2e_Keyboard_Teleop_Normal/Encoder_to_Velocity1/Encoder to Distance'
 * '<S9>'   : 'QBot2e_Keyboard_Teleop_Normal/Encoder_to_Velocity1/Second-Order Low-Pass Filter2'
 * '<S10>'  : 'QBot2e_Keyboard_Teleop_Normal/Encoder_to_Velocity2/Encoder to Distance'
 * '<S11>'  : 'QBot2e_Keyboard_Teleop_Normal/Encoder_to_Velocity2/Second-Order Low-Pass Filter2'
 * '<S12>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal'
 * '<S13>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Basic Motor Commands and Sensor Measurement/QBot2e_IO_Basic'
 * '<S14>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Enabled Moving Average'
 * '<S15>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Switch Case Action Subsystem'
 * '<S16>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Switch Case Action Subsystem1'
 * '<S17>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Switch Case Action Subsystem2'
 * '<S18>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Basic Motor Commands and Sensor Measurement/Bias Removal/Enabled Moving Average/Increment'
 * '<S19>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Full Kinematics (No Gyro)/Qbot2e_Diff_Drive_Kinematics'
 * '<S20>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Full Kinematics (No Gyro)/Qbot2e_Kinematics (No Gyro)'
 * '<S21>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Full Kinematics (No Gyro)/Qbot2e_Diff_Drive_Kinematics/Qbot2_Diff_Drive_Kinematics'
 * '<S22>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Full Kinematics (No Gyro)/Qbot2e_Kinematics (No Gyro)/Qbot2_Kinematics (Vf,W to x_dot,y_dot and psi_dot)'
 * '<S23>'  : 'QBot2e_Keyboard_Teleop_Normal/QBot 2e Inverse Kinematics  (Forward Velocity and Angular Velocity  into Left and Right Wheel Vellocity)/Qbot2e_Inverse_Kinematics  (Forward Velocity and Angular Velocity into Left and Right Wheel Vellocity)'
 */
#endif                         /* RTW_HEADER_QBot2e_Keyboard_Teleop_Normal_h_ */
